...
public class CellularController {
    ...
    public CellularDTO cellulars(@PathVariable(name = "cellularNumber", required = true) @NotBlank(message = "Cellular Number es obligatiorio.") String cellularNumber,
            @RequestParam(name = "handle", defaultValue = "false") @NotNull(message = "El parámetro 'handle' no puede ser nulo") Boolean handle) {
        var cellularDTO = cellularService.findByCellularNumber(cellularNumber, handle);
